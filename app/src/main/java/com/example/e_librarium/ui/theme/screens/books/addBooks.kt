...
fun AddBooksScreen(navController: NavHostController){
    ...
    var bookGenre by remember { mutableStateOf(TextFieldValue("")) }
    var bookAcquisitionMethod by remember { mutableStateOf(TextFieldValue("")) }
    ...
    Column (
        ...
        OutlinedTextField(
            ...
            onValueChange = { bookAcquisitionMethod = it },
            label = { Text(text = "Book Acquisition Method *") },
            colors = TextFieldDefaults.colors(
                focusedTextColor = Color.Blue,
                unfocusedTextColor = Color.Cyan,
                focusedContainerColor = Color.White,
